...
import { IsNumber, IsPositive, IsDateString, IsOptional, IsString, IsBoolean, MaxLength, Min } from 'class-validator';
...
export class CreateInventarioLoteDto {
    ...
    @IsNumber({ maxDecimalPlaces: 4 }, { message: 'La cantidad inicial debe ser un número con máximo 4 decimales' })
    ...
    @IsOptional()
    @IsString()
    @MaxLength(50, { message: 'El número de lote no puede exceder 50 caracteres' })
    numeroLote?: string;
