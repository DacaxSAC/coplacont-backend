...
export class MovimientosController {
    ...
    async create(@Body() createMovimientoDto: CreateMovimientoDto): Promise<ResponseMovimientoDto> {
    ...
    async findOne(@Param('id', ParseIntPipe) id: number): Promise<ResponseMovimientoDto> {
    ...
    @ApiResponse({ status: 404, description: 'Movimiento no encontrado' })
    @ApiResponse({ status: 400, description: 'El movimiento no se puede cancelar' })
    async cancelarMovimiento(@Param('id', ParseIntPipe) id: number): Promise<ResponseMovimientoDto> {
    ...
    @ApiResponse({ status: 404, description: 'Movimiento no encontrado' })
    @ApiResponse({ status: 400, description: 'El movimiento no se puede eliminar' })
