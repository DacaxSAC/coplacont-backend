...
import { IsString, IsOptional, IsBoolean, IsNumber, IsPositive, MaxLength, MinLength } from 'class-validator';
...
export class CreateAlmacenDto {
    ...
    @IsOptional()
    @IsNumber({ maxDecimalPlaces: 2 }, { message: 'La capacidad debe ser un número con máximo 2 decimales' })
