...
export class PermissionService {
    ...
    async findAll () : Promise<ResponsePermissionDto[]> {
        ...
        return plainToInstance(ResponsePermissionDto , permissions , {excludeExtraneousValues: true})
    }
    ...
    async create (createPermissionDto : CreatePermissionDto) : Promise<ResponsePermissionDto> {
        ...
        return plainToInstance(ResponsePermissionDto, permissionSaved , {excludeExtraneousValues: true});
    }
