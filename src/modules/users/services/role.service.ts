...
export class RoleService {
    ...
    async findById (id: number) : Promise<ResponseRolDto> {
        ...
        return plainToInstance(ResponseRolDto, role, {excludeExtraneousValues: true});
    }

    async findAll () : Promise<ResponseRolDto[]> {
        const roles = await this.roleRepository.find();
        return plainToInstance(ResponseRolDto , roles, {excludeExtraneousValues: true})
    }
    ...
    async create ( createRolDto : CreateRolDto) : Promise<ResponseRolDto> {
        ...
        return plainToInstance(ResponseRolDto, roleSaved, {excludeExtraneousValues: true})
    }
